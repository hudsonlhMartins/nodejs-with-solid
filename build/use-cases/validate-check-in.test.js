...
// src/use-cases/validate-check-in.test.ts
...
var ValidateCheckinUseCase = class {
  ...
  async execute({
    ...
    const distanceInMinutesFromCheckInCreation = (0, import_dayjs2.default)(/* @__PURE__ */ new Date()).diff(checkIn.created_at, "minute");
...
describe("Validate CheckIn Use Case", () => {
  ...
  it("should not be able to validate the check-in after 20 minutes og its creation", async () => {
    ...
    const TWENTY_MINUTES_IN_MS = 1e3 * 60 * 21;
