...
// src/use-cases/check-in.test.ts
...
describe("CheckIn Use Case", () => {
  ...
  beforeEach(() => {
    ...
    gymsRepository.create({
      id: "gym_id",
      title: "Gym Name",
      latitude: new import_library.Decimal(0),
      longitude: new import_library.Decimal(0),
      phone: "123456789"
    });
    vi.useFakeTimers();
  });
  ...
  it("should not be able to check-in in twice in the same day", async () => {
    vi.setSystemTime(/* @__PURE__ */ new Date("2021-01-01T12:00:00Z"));
    await sut.execute({
      gymId: "gym_id",
      userId: "user_id",
      userLatidute: 0,
  ...
  it("should be able to check-in in twice but in different days", async () => {
    ...
    vi.setSystemTime(/* @__PURE__ */ new Date("2021-01-02T12:00:00Z"));
    const { checkIn } = await sut.execute({
      gymId: "gym_id",
      userId: "user_id",
      userLatidute: 0,
    ...
    globalExpect(checkIn).toEqual(globalExpect.any(Object));
  });
  it("should not be able to check-in in on distant gyms", async () => {
    gymsRepository.create({
      id: "gym_id_2",
      title: "Gym Name",
      latitude: new import_library.Decimal(-22.3908348),
      longitude: new import_library.Decimal(-41.8096205),
      phone: "123456789"
    });
    vi.setSystemTime(/* @__PURE__ */ new Date("2021-01-01T12:00:00Z"));
    await globalExpect(async () => {
